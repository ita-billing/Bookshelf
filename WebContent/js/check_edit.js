function onEditClick(){
    //入力項目を設定
	var title = edit_book.TITLE.value;
    var progress = edit_book.PROGRESS.value;
    var startdate = edit_book.STARTDATE.value;
    var enddate = edit_book.ENDDATE.value;
    var evaluation = edit_book.EVALUATION.value;
